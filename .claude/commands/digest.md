...
- The publication artifacts: `digests/$CURRENT_DATE-{cadence}.html` and (if produced)
  `digests/$CURRENT_DATE-{cadence}.pdf`, plus the imagery summary (`N embedded, M link-only`).
